...
Here we use the functions in the package `predictFishRMR` to predict various features of a fish's metabolism and ecological constraints based on their mass and physiology type. 
